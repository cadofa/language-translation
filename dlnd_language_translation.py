...
def text_to_ids(source_text, target_text, source_vocab_to_int, target_vocab_to_int):
    ...
    for s in source_texts:
        source_id_text.append(sentence_to_ids(s,source_vocab_to_int, is_target=False))
    for s in target_texts:
        target_id_text.append(sentence_to_ids(s,target_vocab_to_int, is_target=True))
...
def encoding_layer(rnn_inputs, rnn_size, num_layers, keep_prob):
    ...
    """
    # TODO: Implement Function
    basic_lstm_cell = tf.contrib.rnn.BasicLSTMCell(rnn_size)
    enc_cell = tf.contrib.rnn.MultiRNNCell([basic_lstm_cell] * num_layers)
